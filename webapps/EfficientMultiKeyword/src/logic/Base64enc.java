...
public class Base64enc
{
    ...
    public static void encode( java.nio.ByteBuffer raw, java.nio.ByteBuffer encoded ){
        ...
        while( raw.hasRemaining() ){
            ...
            raw.get(raw3,0,rem);
            Base64enc.encode3to4(enc4, raw3, rem, Base64enc.NO_OPTIONS );
            encoded.put(enc4);
        }   // end input remaining
    }
    ...
    throws java.io.IOException {
        ...
        try {
            ...
            b64os = new Base64enc.OutputStream( baos, ENCODE | options );
            if( (options & GZIP) != 0 ){
                // Gzip
    ...
    public static byte[] encodeBytesToBytes( byte[] source ) {
        byte[] encoded = null;
        try {
            encoded = encodeBytesToBytes( source, 0, source.length, Base64enc.NO_OPTIONS );
        } catch( java.io.IOException ex ) {
    ...
    public static byte[] encodeBytesToBytes( byte[] source, int off, int len, int options ) throws java.io.IOException {
        ...
        if( (options & GZIP) != 0 ) {
            java.io.ByteArrayOutputStream  baos  = null;
            java.util.zip.GZIPOutputStream gzos  = null;
            Base64enc.OutputStream            b64os = null;
    ...
    throws java.io.IOException {
        byte[] decoded = null;
            ...
            decoded = decode( source, 0, source.length, Base64enc.NO_OPTIONS );
        return decoded;
    }
    ...
    throws java.io.IOException {
        ...
        Base64enc.OutputStream bos = null;
        try {
            bos = new Base64enc.OutputStream(
                  new java.io.FileOutputStream( filename ), Base64enc.ENCODE );
    ...
    throws java.io.IOException {
        ...
        try{
            bos = new Base64enc.OutputStream(
                      new java.io.FileOutputStream( filename ), Base64enc.DECODE );
    ...
    throws java.io.IOException {
        ...
        Base64enc.InputStream bis = null;
        try
        {
            ...
            // Open a stream
            bis = new Base64enc.InputStream(
                      new java.io.BufferedInputStream(
                      new java.io.FileInputStream( file ) ), Base64enc.DECODE );
    ...
    throws java.io.IOException {
        ...
        try
        {
            ...
            bis = new Base64enc.InputStream(
                      new java.io.BufferedInputStream(
                      new java.io.FileInputStream( file ) ), Base64enc.ENCODE );
            ...
            // Save in a variable to return
            encodedData = new String( buffer, 0, length, Base64enc.PREFERRED_ENCODING );
    ...
    throws java.io.IOException {
        ...
        String encoded = Base64enc.encodeFromFile( infile );
    ...
    throws java.io.IOException {
        ...
        byte[] decoded = Base64enc.decodeFromFile( infile );
        java.io.OutputStream out = null;
        try{
            out = new java.io.BufferedOutputStream(
                  new java.io.FileOutputStream( outfile ) );
            ...
            // Else, Decoding
                ...
                if( decodabet[ theByte & 0x7f ] > WHITE_SPACE_ENC ) {
                    ...
                    if( position >= bufferLength ) { // Enough to output.
                        ...
                        int len = Base64enc.decode4to3( buffer, 0, b4, 0, options );
                        out.write( b4, 0, len );
                        position = 0;
                    }   // end if: enough to output
