...
public interface FileUploadDelegate {
	...
	@RequestWrapper(localName = "upload", targetNamespace = "http://logic.com/", className = "uploadservice.Upload")
	@ResponseWrapper(localName = "uploadResponse", targetNamespace = "http://logic.com/", className = "uploadservice.UploadResponse")
