...
<%--          </div>--%>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <div style="width: 450px;height: 350px;border: 1px solid;margin-left: 250px;">
          <center>
          <form action="MSearch" method="post">
          <br/><br/>
          <label style="font-family: sans;font-size: 20px;color: black;">Search</label>
          <br/><br/>
          <input type="text" name="searchdata" style="width: 400px;height: 25px;font-family: sans;font-size: 18px;"/>
           <br/><br/> <br/>
           <input type="submit" value="SEARCH" style="font-family: sans;font-size: 18px;font-weight: bold;cursor: pointer;"/>
          </form>
          <br/><br/>
          </center>
          <%
        	...
        	%>
          		<center><label style="font-family: sans;font-size: 18px;color: black;"><a style="color:#DC143C" href="ViewMedia?filename=<%=fname %>"><%=fname %></a></label></center>
         <%	}
